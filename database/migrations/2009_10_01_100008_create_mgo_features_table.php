...
class CreateMgoFeaturesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('mgo_features', function (Blueprint $table) {
            ...
            $table->string('attr')->nullable()->comment('功能属性(list:{column:[title,logo,...],order_by:[created_at,updated_at],search:[title,deleted_at,...]},add:{...},update:[{column:name,edit:false},{column:logo,edit:true}])');
            $table->timestamps();
        });
